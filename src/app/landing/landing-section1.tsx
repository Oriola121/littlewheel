...
export default function LandingSection1() {
  return (
    <div className="bg-black rounded-3xl h-auto text-white flex flex-col relative pb-9">
      ...
      <div className="w-full flex flex-col items-center z-10 px-6">
        <h1 className="text-3xl md:text-4xl font-extrabold text-center -mt-20">
          Build Financial Freedom
          <br />
          with the Little Wheel
        </h1>
        <p className="text-xs md:text-sm text-white/80 text-center sm:mt-0 mt-2">
